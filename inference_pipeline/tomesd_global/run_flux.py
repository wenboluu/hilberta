...
def generate_image(
    ...
    flux_scheduler = FluxScheduler(
        ...
        config_path="/scratch/sz3684/reorder_local_attention/inference_pipeline/tomesd_global/transformer_layer_config.yaml",
    )
    #********************************************************************************************************************
    import types
    ...
    file_name = f"{datetime.now().strftime('%m-%d-%H-%M-%S')}*{'Lora'}*{random_seed}.png"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", 
        type=str,
        default="/scratch/sz3684/reorder_local_attention/inference_pipeline/tomesd_global/config.yaml",
    ...
    for ratio in ratio_list:
        ...
        output_folder = f"/scratch/sz3684/reorder_local_attention/inference_pipeline/tomesd_global/output/{toma_variant}/{ratio}"
        ...
        # pipeline.load_lora_weights("/scratch/sz3684/reorder_local_attention/training_pipeline/exp_output/checkpoint-500")
